...
whatsapp_mode_a_reply_directive = Template("\n".join([
    ...
    "أو زمنية. إذا سأل المريض عن خدمة طبية، جراحة، أو تخصص (مثل زراعة "
    ...
    "المريض ما طلبش الحساب ده، وهو مش مكتوب حرفيًا في الـ CONTEXT. مثال "
    "حرفي على اللي ممنوع تمامًا تعمله: لو الـ CONTEXT بيقول 'النسبه: "
    "0.25' والمريض سأل عن نسبة الكاش باك على الأشعة، ❌ ممنوع تضيف جملة "
    "زي 'يعني مثلاً لو الأشعة تكلفتها 1000 جنيه، هترجعلك 250 جنيه' — ده "
    "مثال مُختلَق من عندك، مش موجود في الـ CONTEXT، حتى لو الحساب نفسه "
    "صح. ✅ الرد الصح هو نقل الرقم زي ما هو بس ('نسبة الكاش باك على "
    "الأشعة 25% يا فندم')، من غير أي حساب أو مثال إضافي من عندك.",
    "",
