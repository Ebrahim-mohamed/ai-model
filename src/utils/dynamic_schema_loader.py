...
async def discover_and_register_schema(
    ...
    they actually read off a sheet's header row (`df.columns`, once Step 5
    wires up real file parsing) — this function only forwards that list to
    the registry's upsert-on-discovery logic.
    """
